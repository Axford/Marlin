...
D5 - laser PSU on/off (active ?, to relay control board)
...
#define LASER_POWERLEVEL_PIN 	6
#define LASER_FIRE_PIN    	7
#define LASER_PSU_ON_PIN	52 

#define LASER_MAX_PWM_DUTYCYCLE 75.0   // max duty cycle as a percentage in range 0-100 - calibrate to max current level for laser tube
...
void laser_init() {
	...
	digitalWrite(LASER_PSU_ON_PIN, LOW);
